    ...
    return (
        <div className="rounded-md bg-teal-800 pt-8" id="projects">
            ...
            <div className="border-gray-200">
                <Tabs.Root
                    className="TabsRoot w-full shadow-none"
                    defaultValue="tab1"
                >
                    <Tabs.List
                    ...
                    >
                        <Tabs.Trigger
                            className="TabsTrigger border-none font-sans text-lg font-bold shadow-none ring-0 data-[state=active]:bg-white data-[state=active]:text-amber-500"
                            value="tab1"
                        >
                            FullStack
                        </Tabs.Trigger>
