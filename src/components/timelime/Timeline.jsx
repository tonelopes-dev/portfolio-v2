...
import CardTimeline from "../CardTimeline/CardProject";
    ...
    <div className=" pb-5 mb-5">
      ...
      <ol className="relative border-l border-gray-200 dark:border-gray-700">
        <li className="mb-10 ml-6 text-left ">
          ...
          <CardTimeline className="text-left justify-start " />
        </li>
        <li className="mb-10 ml-6 text-left ">
          <span className="absolute flex items-center justify-center w-6 h-6 bg-blue-100 rounded-full -left-3 ring-8 ring-white dark:ring-gray-900 dark:bg-blue-900">
            <svg
          ...
          <h3 className="mb-1 text-lg font-semibold text-gray-900 dark:text-white">Novembro de 2022 - Junho de 2022</h3>
          <time className="block mb-2 text-sm font-normal leading-none text-gray-400 dark:text-gray-500">
            Rocketseat Digital House, Rio do Sul-SC
          </time>
          <CardTimeline
        ...
        <li className="ml-6 text-left ">
          ...
          <h3 className="mb-1 text-lg font-semibold text-gray-900 dark:text-white">JUNHO DE 2016 - JUNHO DE 2018</h3>
